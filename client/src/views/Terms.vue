...
v-container#Terms
  v-row
    v-col.text-justify
      ...
      p Last updated: January 19, 2020
      ...
      ul
        ...
        li
          strong Company
          |  (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to Video Game Recommender.
        li
          strong Country
          |  refers to: North Rhine-Westphalia, Germany
        li
          strong Service
          |  refers to the Website.
        li
          strong Terms and Conditions
          |  (also referred as "Terms") mean these Terms and Conditions that form the entire agreement between You and the Company regarding the use of the Service. This Terms and Conditions agreement as been created with the help of
          a(href='https://www.termsfeed.com/terms-conditions-generator/') Terms and Conditions Generator
          | .
        li
        ...
        li
          strong Website
          |  refers to Video Game Recommender, accessible from http://www.vgr.best
        li
          strong You
      ...
      p You agree that the original English text shall prevail in the case of a dispute.
      ...
      ul
        li By email: info@vgr.best
        li By visiting this page on our website: http://www.vgr.best/contact

</template>

<script>
export default {
  namer: 'termsAndConditions'
}
</script>
